...
from .consumers import ws_connect, ws_receive, ws_disconnect, chat_join, chat_leave, chat_send, chat_download, new_room, delete_room
...
custom_routing = [
    ...
    route("chat.receive", chat_download, command="^download$"),
    route("chat.receive", new_room, command="^new_room$"),
    route("chat.receive", delete_room, command="^delete_room$"),
]
